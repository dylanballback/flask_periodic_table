...
# Updated data for the periodic table of elements
...
elements_data = [
    ...
    (103, "Lr", "Lawrencium", 262, "transition metal"),
    ...
    (109, "Mt", "Meitnerium", 278, "none"),
    (110, "Ds", "Darmstadtium", 281, "none"),
    (111, "Rg", "Roentgenium", 282, "none"),
    (112, "Cn", "Copernicium", 285, "none"),
    (113, "Nh", "Nihonium", 286, "none"),
    (114, "Fl", "Flerovium"	, 289, "none"),
    (115, "Mc", "Moscovium", 290, "none"),
    (116,"Lv", "Livermorium", 293, "none"),
    (117,"Ts", "Tennessine", 294, "none"),
    (118, "Og", "Oganesson", 294, "none")
]

# Reconnect to the SQLite database and update it with all elements
...
c.execute('''CREATE TABLE elements
             (atomic_number integer, symbol text, name text, atomic_mass real, category text)''')

# Insert updated data into the table
c.executemany('INSERT INTO elements VALUES (?,?,?,?,?)', elements_data)

# Save (commit) the changes and close the connection
conn.commit()
conn.close()

print('Updated Periodic Table database created and populated with all elements.')